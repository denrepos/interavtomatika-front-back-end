<ul class="subsubsub">
	...
	<li><a href="#empty-product-by-category"><?php _e( 'Delete Products by Product Category', 'woo_st' ); ?></a> |</li>
...
<?php } ?>
		...
		<div class="postbox">
			<h3 class="hndle" id="empty-product-by-category"><?php _e( 'Delete Products by Product Category', 'woo_st' ); ?></h3>
			<div class="inside">
<?php if( $categories ) { ?>
