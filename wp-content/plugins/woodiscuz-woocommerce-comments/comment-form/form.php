        ...
        if ($this->is_guest_can_comment()) {
            ...
            <form action="" method="post" id="wpc_comm_form-<?php echo $unique_id; ?>" class="wpc_comm_form wpc_main_form <?php echo $wpc_form_has_comments; ?>">
                <div class="wpc-field-comment">
                    ...
                    <div style="margin-left:65px;" class="woodiscuz-item"><textarea id="wpc_comment-<?php echo $unique_id; ?>" class="wpc_comment" name="wpc_comment" required="required" placeholder="<?php echo $textarea_placeholder; ?>"></textarea></div>
                ...
                <div id="wpc-form-footer-<?php echo $unique_id; ?>" class="wpc-form-footer">
                    ...
                    <div class="wpc-form-submit">
                        <?php if (!$this->wpc_options_serialized->wpc_captcha_show_hide) { ?>
                            ...
                            <?php } ?>
                        <?php } ?>
                        <div class="wpc-field-submit"><input type="button" name="submit" value="<?php echo $this->wpc_options_serialized->wpc_phrases['wpc_submit_text']; ?>" id="wpc_comm-<?php echo $unique_id; ?>" class="wpc_comm_submit button alt"/></div>
                        <div style="clear:both"></div>
                    </div>
