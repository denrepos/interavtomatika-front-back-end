var MalinkyAjaxPaging = function (n) {
    function t(n, t, a) {
        var i;
        return function () {
            var e = this, o = arguments, l = function () {
    ...
    var d = function () {
        ...
        n.ajax({
            type: "GET", url: f, dataType: "html", success: function (t) {
                var a = n.parseHTML(t), i = n(a).find(u), e = n(g + " " + u).last(), o = n(u);
                if (e.after(i), ("infinite-scroll" == p || "load-more" == p) && (y++, y > c && (n("#malinky-ajax-pagination-button").parent().remove(), window.removeEventListener("scroll", S)), f = f.replace(/\/page\/[0-9]*/, "/page/" + y)), "pagination" == p) {
                ...
                "pagination" == p && n("body,html").animate({scrollTop: n(g).offset().top - 150}, 400)
            }
        })
    }, _ = function () {
