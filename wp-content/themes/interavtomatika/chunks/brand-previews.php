...
<div class="slider-window-wrap qwe">
        ...
        <div class="manufacturers-previews slider-container">
            <div class="general-preview-wrap">
                <div class="general-preview">
                    ...
                    <a href="/brands/brand.php" class="img-wrap"><img src="<?php echo get_template_directory_uri(); ?>/images/demo/manufacturer.png" alt=""/></a>
                    <a href="/brands/brand.php" class="manufacturers-preview-description">OEM Automatic фильтры, системы фильтрации и адсорбенты, промышленные датчики температуры</a>
                </div>
                <div class="general-preview">
                    <div class="manufacturers-preview-title">Oem Automatic</div>
                    <div class="preview-product-count">4354</div>
                    <a href="#" class="img-wrap"><img src="<?php echo get_template_directory_uri(); ?>/images/demo/manufacturer.png" alt=""/></a>
